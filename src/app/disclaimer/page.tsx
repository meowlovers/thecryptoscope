...
export const metadata: Metadata = { title: "Disclaimer — TheChartScope" };
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-[#0d1821] border border-[#1a2d3d] rounded-2xl p-6 sm:p-8">
            <p className="text-[#64748b] text-sm leading-relaxed mb-4">
              <strong className="text-[#e8f0f7]">TheChartScope is not a financial advisor.</strong>{" "}
              All analysis reports, commentary, and any other content produced by TheChartScope are
            ...
            <p className="text-[#64748b] text-sm leading-relaxed mb-4">
              TheChartScope does not recommend that any cryptocurrency should be bought, sold, or held.
              Each individual must conduct their own due diligence and consult with a qualified
              financial professional before making any investment decision.
            </p>
            <p className="text-[#64748b] text-sm leading-relaxed">
              By using TheChartScope&apos;s services, you acknowledge and accept that any action taken
              based on our analysis is at your own risk. TheChartScope and its team members bear no
